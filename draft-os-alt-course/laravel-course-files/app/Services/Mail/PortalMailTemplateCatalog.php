...
final class PortalMailTemplateCatalog
{
    ...
    public static function all(): array
    {
        ...
        $items = [
            ...
            [
                'id' => PortalMailLog::TYPE_MAILING_GROUP_NOTIFY,
                'type' => PortalMailLog::TYPE_MAILING_GROUP_NOTIFY,
                'title' => 'Оповещение группы рассылки',
                'eyebrow' => 'Группы рассылок',
                'headline' => 'Открыт курс на портале',
                'subject' => 'На учебном портале открыт курс: {название курса}',
                'greeting' => 'Привет!',
                'lead' => 'На учебном портале открыт курс. Пройти можно под корпоративной почтой @croc.ru.',
                'details' => [
                    'Курс' => 'Особенности ОС «Альт»',
                    'Группа рассылки' => 'IT-запрос',
                    'Адрес' => 'itrequest@croc.ru',
                ],
                'cta_label' => 'Открыть портал',
                'cta_url' => $portal,
                'triggers' => [
                    'В админке курса выбрали AD-группы рассылок и нажали «Отправить оповещение».',
                    'Письмо уходит на адрес группы (distribution list), без персональной записи на курс.',
                ],
            ],
        ];
