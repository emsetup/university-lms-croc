...
final class AdminNavigation
{
    ...
    public static function courseTab(): ?string
    {
        ...
        return match ($name) {
            ...
            'admin.course.section.panel.save',
            'admin.quiz.edit.module',
            'admin.quiz.edit.final',
            'admin.quiz.save.module',
            'admin.quiz.save.final' => 'course_modules',
            'admin.theory.zip',
            ...
            'admin.learners.course.learner',
            'admin.learners.course.learner.module',
            'admin.learners.course.learner.reset' => 'learners',
            'admin.course.surveys',
            'admin.course.surveys.export.wide',
            'admin.course.surveys.export.long',
            'admin.course.module.section.survey-responses',
            'admin.course.module.section.survey-responses.export' => 'surveys',
            'admin.certificates',
