...
final class StaffRoleGuide
{
    ...
    public static function roles(): array
    {
        return [
            ...
            PortalStaff::ROLE_PORTAL_AUDITOR => [
                'label' => 'Аудитор портала',
                'badge' => 'auditor',
                'summary' => 'Логи, почта и сводная статистика портала по всем курсам. Создаёт и правит только свои курсы; чужие — просмотр статистики.',
                'admin_note' => 'Доступ к /adm: логи, /adm/statistika, настройки, все курсы на чтение статистики',
                'capabilities' => self::cells(
                    admin: ['yes', 'Да'],
                    courses: ['own', 'Свои + стат. чужих'],
                    content: ['own', 'Только свои'],
                    learners: ['yes', 'Все курсы'],
                    people: ['yes', 'Да'],
                    docker: ['own', 'Только свои'],
                    logs: ['yes', 'Логи + статистика'],
                    staff: ['no', '—'],
                    settings: ['yes', 'Да'],
                ),
            ],
    ...
    private static function cells(
        ...
        return [
            ...
            'logs' => ['level' => $logs[0], 'label' => $logs[1]],
