...
{
    private const LEGACY_SLUGS = ['alt-os-features', 'rhcsa'];
    ...
    public function up(): void
    {
        ...
        DB::table('courses')
            ...
            ->whereNull('created_by_portal_staff_id')
            ->update([
    ...
    {
        $staffId = $this->resolveMednikovStaffId();
        if ($staffId === null || ! Schema::hasColumn('courses', 'created_by_portal_staff_id')) {
            return;
        }
