...
@section('content')
    ...
    <script>
        ...
        (function () {
            ...
            var navBtns = document.querySelectorAll('#tl-jump .quick-nav-btn');
            var jumpNav = document.getElementById('tl-jump');
            ...
            if (sections.length && navBtns.length) {
                var observer = new IntersectionObserver(function (entries) {
                    ...
                    entries.forEach(function (entry) {
                        ...
                        var active = document.querySelector('#tl-jump .quick-nav-btn[href="' + href + '"]');
                        if (!active) {
                            return;
                        }
                        setActiveNav(href);
            ...
            if (navBtns.length && !document.querySelector('#tl-jump .quick-nav-btn.active')) {
