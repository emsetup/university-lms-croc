...
View::composer(['layouts.course', 'admin.*', 'portal.*'], function ($view) {
...
Route::middleware([\App\Http\Middleware\EnsureLearner::class, \App\Http\Middleware\EnsurePortalStaff::class])->group(function () {
    ...
    Route::get('/adm/obuchayushiesya', [AdminLearnersController::class, 'indexPortal'])
        ->middleware([\App\Http\Middleware\EnsureStaffAbility::class.':view_portal_learners'])
        ->name('admin.learners.portal');
